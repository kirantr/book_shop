...
CREATE TABLE `ORDER` (
	...
	`date_time` TIMESTAMP(16) NOT NULL,
...
ALTER TABLE `BOOKS` ADD CONSTRAINT `BOOKS_fk0` FOREIGN KEY (`discount`) REFERENCES `DISCOUNT`(`id`);
...
ALTER TABLE `ORDER` ADD CONSTRAINT `ORDER_fk0` FOREIGN KEY (`id_customer`) REFERENCES `CUSTOMERS`(`id`);

ALTER TABLE `ORDER` ADD CONSTRAINT `ORDER_fk1` FOREIGN KEY (`id_status`) REFERENCES `ORDER_STATUS`(`id`);

ALTER TABLE `ORDER` ADD CONSTRAINT `ORDER_fk2` FOREIGN KEY (`id_payment`) REFERENCES `PAYMENT`(`id`);

ALTER TABLE `ORDER` ADD CONSTRAINT `ORDER_fk3` FOREIGN KEY (`discount_customer`) REFERENCES `CUSTOMERS`(`discount`);

ALTER TABLE `ORDER_FULL_INFO` ADD CONSTRAINT `ORDER_FULL_INFO_fk0` FOREIGN KEY (`id_book`) REFERENCES `BOOKS`(`id`);

ALTER TABLE `ORDER_FULL_INFO` ADD CONSTRAINT `ORDER_FULL_INFO_fk1` FOREIGN KEY (`id_order`) REFERENCES `ORDER`(`id`);
